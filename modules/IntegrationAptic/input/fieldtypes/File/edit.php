	...
	foreach($data as $obj)
	{
		...
		<div class="item row">
			<div class="col-md-1 col-xs-2">
				<div class="thumbnail"><a class="<?php echo $field_ui_id;?>_fancy script" href="<?php echo ($o_main->activate_cdn?"":$extradomaindirroot).$file.(strpos($file,'uploads/protected/')!==false?($o_main->multi_acc?$s_protected_cdn:$s_protected_local):'');?>" download=""><img class="ptr" src="<?php echo $extradir."/input/fieldtypes/".$field[4];?>/images/download.png"></a></div>
			</div>
