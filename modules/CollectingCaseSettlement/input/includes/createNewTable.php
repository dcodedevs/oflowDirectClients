...
if(isset($_POST['send']))
{
	...
	if(count($error_msg)==0)
	{
		...
		while($writeBase = readdir($findBase))
		{
			...
			if($fieldParts[1] == "php" && $fieldParts[0] != "" && $fieldParts[0] != $tableName && $fieldParts[2] != "LCK")
			{
				$tablecounter++;
			}
		}
