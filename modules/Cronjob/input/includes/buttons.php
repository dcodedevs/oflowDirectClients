...
if($access >= 10)
{
	...
	if(($fw_showCustomized && !isset($_GET['ID'])) || $buttonlisttype == "list")
	{
		...
		if($variables->developeraccess >= 10) //Designer access
		{
			?><li><a class="optimize" href="<?php echo $_SERVER['PHP_SELF']."?pageID=".$_GET['pageID']."&accountname=".$_GET['accountname']."&companyID=".$_GET['companyID']."&caID=".$_GET['caID']."&module=".$module."&actionType=changeOutputLanguage";?>"><?php echo $formText_editOutputLanguage_inputButton;?></a></li><?php
		}
		if($variables->developeraccess >= 20) //Developer access
		{
			?><li><a class="optimize" href="<?php echo $_SERVER['PHP_SELF']."?pageID=".$_GET['pageID']."&accountname=".$_GET['accountname']."&companyID=".$_GET['companyID']."&caID=".$_GET['caID']."&module=".$module."&actionType=changeOutputSettings";?>"><?php echo $formText_editOutputSettings_inputButton;?></a></li><?php
		}
		if($variables->developeraccess >= 20) //Developer access
		{
