...
if(isset($_POST['send']))
{
	...
	$newFile = $_POST['choosenparentfield']."¤".$moduleInfoSplit[2]."¤".$moduleInfoSplit[1]."¤".$_POST['choosenmodulefield']."¤1¤".$_POST['newbutton']."¤".$_POST['showbutton']."¤".$_POST['choosennamefield']."¤".$_POST['contentstatusfilter']."¤".$s_relation_lang_variable."¤".$_POST['items_per_page']."¤".$_POST['expand_list']."¤".$_POST['in_hidden_list']."¤";
...
if(isset($_GET['editorder']))
{
	...
	if(!isset($_GET['relationedit']) && !isset($_GET['editorder']))
	{
		...
		if($_GET['relationedit'] != '-1')
		{
			...
			$relationValue = split("¤",$prerelations[$_GET['relationedit']]);
		}
		?>
