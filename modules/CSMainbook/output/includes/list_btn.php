    ...
    <div class="top_filter_column">
        <div class="addNewVatBtn btnStyle">
    		<div class="plusTextBox active">
    			...
    			<div class="text"><?php
                echo $formText_AddNewPayment_Output;
                ?></div>
    		</div>
    		<div class="clear"></div>
    	</div>
		<div class="addNewVoucherBtn btnStyle">
    		<div class="plusTextBox active">
    			<div class="plusBox addres"><div class="lineH"></div><div class="lineV"></div></div>
    			<div class="text"><?php
                echo $formText_AddNewVoucher_Output;
                ?></div>
    		</div>
    		<div class="clear"></div>
    	</div>

		<div class="importPayments btnStyle">
			<div class="plusTextBox active">
				<div class="plusBox addres"><div class="lineH"></div><div class="lineV"></div></div>
        ...
        <div class="viewTransactions btnStyle">
    		<div class="plusTextBox active">
    			<div class="text"><?php
                echo $formText_ViewTransactions_Output;
                ?></div>
    		</div>
    		<div class="clear"></div>
    	</div>
		<div class="viewBalance btnStyle">
    		<div class="plusTextBox active">
    			<div class="text"><?php
                echo $formText_ViewBalance_Output;
                ?></div>
    		</div>
    		<div class="clear"></div>
    	</div>
...
<script type="text/javascript">
	...
	$(".viewTransactions").on("click",function(e){
        ...
        loadView("transactionlist");
	})
	$(".viewBalance").on("click",function(e){
		e.preventDefault();
        var data = {
            id: 0
        };
        loadView("balancelist");
	})
	$(".addNewVoucherBtn").off("click").on("click", function(e){
		e.preventDefault();
        var data = {
            id: 0,
			voucherOnly: 1
