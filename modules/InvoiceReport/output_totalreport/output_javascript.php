<script type="text/javascript">
    ...
    function ajaxCall(includeFile, data, callback, showLoader) {
        ...
        $.ajax({
            ...
            type: 'POST',
            dataType: 'json',
            url: '<?php echo $_SERVER['PHP_SELF']."?pageID=".$_GET['pageID']."&accountname=".$_GET['accountname']."&companyID=".$_GET['companyID']."&caID=".$_GET['caID']."&module=".$module."&folderfile=output&folder=".$folderName."&inc_obj=ajax&inc_act="; ?>' + includeFile,
            data: ajaxData,
    ...
    function loadView(includeFile, data) {
        ...
        // Load view
        fw_load_ajax("<?=$_SERVER['PHP_SELF']."?pageID=".$_GET['pageID']."&accountname=".$_GET['accountname']."&companyID=".$_GET['companyID']."&caID=".$_GET['caID']."&module=".$module."&folder=output&folderfile=".$folderName;?>&inc_obj=" + includeFile + '&' + urlParams, '', true);
