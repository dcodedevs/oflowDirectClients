...
if($moduleAccesslevel > 10) {
	if(isset($_POST['output_form_submit'])) {
        if ($claimline_id) {
			...
			court_fee_invoiced_creditor_invoice_nr='".$o_main->db->escape_str($_POST['court_fee_invoiced_creditor_invoice_nr'])."'
...
<div class="popupform popupform-<?php echo $caseId;?>">
	...
	<form class="output-form main" action="<?php print $_SERVER['PHP_SELF']."?pageID=".$_GET['pageID']."&accountname=".$_GET['accountname']."&companyID=".$_GET['companyID']."&caID=".$_GET['caID']."&module=".$module."&folderfile=output&folder=output&inc_obj=ajax&inc_act=edit_invoice_nr";?>" method="post">
		...
		<div class="inner">
    		...
    		<div class="line">
        		<div class="lineTitle"><?php echo $formText_CourtFeeInvoicedCreditorInvoiceNr_Output; ?></div>
        		<div class="lineInput">
                    <input type="text" class="popupforminput botspace" autocomplete="off" name="court_fee_invoiced_creditor_invoice_nr" value="<?php echo $projectData['court_fee_invoiced_creditor_invoice_nr']; ?>" >
                </div>
        		<div class="clear"></div>
    		</div>
