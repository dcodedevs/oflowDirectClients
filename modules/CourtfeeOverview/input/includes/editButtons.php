...
if(isset($_POST['savebutton']))
{
	...
	sanitize_escape($_POST['submodule'], 'string', $submodule);
	sanitize_escape($_POST['buttontype'], 'string', $buttontype);
	sanitize_escape($_POST['tableconnect'], 'string', $tableconnect);
	$tableconnect = explode(":",$tableconnect);
	$extra = "";
	
	sanitize_escape($_GET['fieldWork'], 'string', $fieldWork);
	...
	$variables = sys_get_button_config("/modules/$module/input/settings/buttonconfig/".$submodule.$buttontype.".php", $account_absolute_path);
	...
	ftp_file_put_content("/modules/$module/input/settings/buttonconfig/".$submodule."".$buttontype.".php",str_replace("[%]","$","<?php\n{$outString}\n?>"));
