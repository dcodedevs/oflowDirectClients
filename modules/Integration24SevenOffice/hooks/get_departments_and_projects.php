...
$run_hook = function($data) {
    ...
    if($creditorData){
		...
		$department_result = $api->get_departments();
		$departments = $department_result['GetDepartmentListResult']['Department'];
		if(isset($departments['Id'])){
			$departments = array($departments);
		}
		$project_result = $api->get_projects();
		$projects = $project_result['GetProjectListResult']['Project'];
