...
<?php if (!$rowOnly) { ?>
	...
	<div class="gtable" id="gtable_search">
	    <div class="gtable_row">
	        <div class="gtable_cell gtable_cell_head"><?php echo $formText_KeycardNumber_output;?></div>
	        <div class="gtable_cell gtable_cell_head"><?php echo $formText_KeycardNumberHex_output;?></div>
...
<?php } ?>
    ...
    foreach($customerList as $v_row){
        ...
        ?>
        <div class="gtable_row">
            <div class="gtable_cell"><?php echo $v_row['keycardNumber'];?></div>
            <div class="gtable_cell"><?php echo $v_row['keycard_number_hex'];?></div>
            <div class="gtable_cell"><?php echo date("d.m.Y", strtotime($v_row['created']));?></div>
            <div class="gtable_cell"><?php if($v_row['deactivatedTime'] == null || $v_row['deactivatedTime'] == '0000-00-00') { echo '<span class="activeKeycard">'.$formText_Active_outputKeycard.'</span>'; } else { echo date("d.m.Y", strtotime($v_row['deactivatedTime'])); }?></div>
