...
if($moduleAccesslevel > 10) {
	if(isset($_POST['output_form_submit'])) {
        if ($subscribtionId) {
			...
			comment = ?
            WHERE id = ?";
            $o_main->db->query($s_sql, array($variables->loggID, $_POST['comment'], $subscribtionId));
...
<div class="popupform">
	...
	<form class="output-form main" action="<?php print $_SERVER['PHP_SELF']."?pageID=".$_GET['pageID']."&accountname=".$_GET['accountname']."&companyID=".$_GET['companyID']."&caID=".$_GET['caID']."&module=".$module."&folderfile=output&folder=output&inc_obj=ajax&inc_act=editSubscriptionComment";?>" method="post">
		...
		<div class="inner">
			<div class="line">
				...
				<div class="lineInput">
					<textarea class="popupforminput botspace" name="comment"  autocomplete="off"><?php echo $subscribtionData['comment']; ?></textarea>
				</div>
				<div class="clear"></div>
			</div>
