...
$s_request = APIconnectorAccount("account_status_set", $v_accountinfo['accountname'], $v_accountinfo['password'], $v_param);
	...
	<div class="inner">
		...
		if($v_response !== NULL && $v_response['status'] == 1)
		{
			if($_POST['status'] == 2)
			{
				...
				echo $formText_AccountStatusHasBeenChanged_Output;
			}
		} else {
