...
$action ='upload_image';
if($_GET['type'] == 'file' || $_GET['type'] == 'video'){
	$action = 'upload_file';
}
...
$s_response = APIconnectAccount("account_authenticate", $v_accountinfo['accountname'], $v_accountinfo['password'], array('VALID_COUNT'=>20));
