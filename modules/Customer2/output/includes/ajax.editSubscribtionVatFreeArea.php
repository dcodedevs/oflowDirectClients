...
<div class="popupform">
	...
	<form class="output-form main" action="<?php print $_SERVER['PHP_SELF']."?pageID=".$_GET['pageID']."&accountname=".$_GET['accountname']."&companyID=".$_GET['companyID']."&caID=".$_GET['caID']."&module=".$module."&folderfile=output&folder=output&inc_obj=ajax&inc_act=editSubscribtionVatFreeArea";?>" method="post">
		...
		<div class="inner">
    		<div class="line">
        		...
        		<div class="lineInput">
                    <input type="text" class="popupforminput botspace" name="vatFreeArea" value="<?php if($subscribtionData['vatFreeArea'] != ""){ echo $subscribtionData['vatFreeArea']; } ?>" autocomplete="off">
                </div>
        		<div class="clear"></div>
    		</div>
		</div>
