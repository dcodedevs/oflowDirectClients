...
<form class="output-form" action="<?php echo $_SERVER['PHP_SELF']."?pageID=".$_GET['pageID']."&accountname=".$_GET['accountname']."&companyID=".$_GET['companyID']."&caID=".$_GET['caID']."&module=".$module."&folderfile=output&folder=output&inc_obj=ajax&inc_act=edit_order_reference";?>" method="post">
	...
	<div class="inner">
		...
		<div class="line">
		<div class="lineTitle"><?php echo $formText_Reference_Output; ?></div>
