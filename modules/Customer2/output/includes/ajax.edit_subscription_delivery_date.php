...
if($moduleAccesslevel > 10)
{
	...
	{
		if(isset($_POST['subscriptionmultiId']) && $_POST['subscriptionmultiId'] > 0 && !empty($_POST['delivery_date']))
		{
...
<form class="output-form" action="<?php echo $_SERVER['PHP_SELF']."?pageID=".$_GET['pageID']."&accountname=".$_GET['accountname']."&companyID=".$_GET['companyID']."&caID=".$_GET['caID']."&module=".$module."&folderfile=output&folder=output&inc_obj=ajax&inc_act=edit_subscription_delivery_date";?>" method="post">
