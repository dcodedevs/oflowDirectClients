...
<?php
$current_content_id = ($_POST['customerId']);

// Create & check folders
require_once __DIR__ . '/filearchive_functions.php';
create_customer_folders($o_main, $current_content_id);
...
function reloadPage() {
	var redirect_url = '<?php echo $_SERVER['PHP_SELF']."?pageID=".$_GET['pageID']."&accountname=".$_GET['accountname']."&companyID=".$_GET['companyID']."&caID=".$_GET['caID']."&module=".$module."&folderfile=output&folder=output&inc_obj=details&cid=".$_POST['customerId']; ?>';
