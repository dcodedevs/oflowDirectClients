...
if ($uid && $collectingorderId) {
    ...
    $s_sql = "SELECT * FROM offer_attached_files WHERE id = ?";
    ...
    if($o_query && $o_query->num_rows() > 0){
        ...
        $o_query = $o_main->db->query("UPDATE offer_attached_files SET  file = ? WHERE id = ?", array($newFilesJson, $collectingorderId));
    }
}
?>
