<?php
$article_id = $_POST['article_id'] ? $o_main->db->escape_str($_POST['article_id']) : 0;
            ...
            <div class="inner">
        		...
        		<div class="line">
            		...
            		<div class="lineInput">
						...
						if($v_article) { ?>
						<a href="#" class="selectArticle"><?php echo $v_article['id'];?></a>
						<?php } else { ?>
						<a href="#" class="selectArticle"><?php echo $formText_SelectArticle_Output;?></a>
						<?php } ?>
						<input type="hidden" name="article_id" id="article_id" value="<?php print $v_article['id'];?>" required>
                    </div>
            		<div class="clear"></div>
        		</div>
        		<div class="line">
            		<div class="lineTitle"><?php echo $formText_ArticleText_Output; ?></div>
            		<div class="lineInput">
                        <input type="text" class="popupforminput botspace" id="article_text" autocomplete="off" name="article_text" required value="<?php echo htmlentities($_POST['article_text']);?>">
                    </div>
            		<div class="clear"></div>
        		</div>
    		</div>
        ...
        submitHandler: function(form) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    fw_loading_end();
                    $(".selectArticleItem").data("id", $("#article_id").val());
                    $(".selectArticleItem").data("articlename", $("#article_text").val());
