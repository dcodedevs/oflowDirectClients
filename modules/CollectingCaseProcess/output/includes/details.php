...
$sql = "SELECT * FROM collecting_cases_process WHERE id = $cid";
$o_query = $o_main->db->query($sql);
		...
		<div class="p_content">
			<div class="p_pageContent">
				...
				<div class="p_pageDetailsTitle">
					...
					<div style="float: right;"‍><?php if($process['type'] == 0){ echo $formText_ReminderLevel_output;} else if($process['type'] == 1) { echo $formText_CollectingLevel_output;} ?></div>
					<div class="clear"></div>
				</div>
				<?php
							...
							foreach($process_steps as $process_step) {
								...
								<div class="processStepBlock">
									...
									<div class="p_contentBlockWrapper">
										<div class="processStepDetails">
											<div class="p_pageDetailsSubTitle2 white ">
												<?php echo $formText_UpdateCaseContent_Output;?>
											</div>
											<div class="p_pageDetailsContent processStepContent">
												<table class="mainTable" width="100%" border="0" cellpadding="0" cellspacing="0">
													<tr>
														<td class="txt-label"><?php echo $formText_Status_output;?></td>
														<td class="txt-value">
															<?php
																echo $main_status['name'];
															?>
														</td>
													</tr>
													<?php if($sub_status) { ?>
														<tr>
															<td class="txt-label"><?php echo $formText_SubStatus_output;?></td>
															<td class="txt-value">
																<?php
													...
													<tr>
										                ...
										                <td class="txt-value">
															...
															if(intval($process_step['claim_type_2_article']) > 0){
										        ...
										        <table class="mainTable btn-edit-table" width="100%" border="0" cellpadding="0" cellspacing="0">
										            <tr>
										                <td class="txt-label"></td>
										                <td class="txt-value"></td>
										                <td class="btn-edit" colspan="2"><?php if($moduleAccesslevel > 10) { ?><button class="output-btn small output-edit-process-step-content editBtnIcon" data-process-id="<?php echo $cid; ?>" data-process-step-id="<?php echo $process_step['id']; ?>"><span class="glyphicon glyphicon-pencil"></span></button><?php } ?></td>
										            </tr>
										        </table>
											</div>
										</div>
										...
										<div class="processStepDetails">
											...
											<div class="p_pageDetailsSubTitle2 white ">
												<?php echo $formText_CreateActions_Output;?>
												<?php if($moduleAccesslevel > 10) { ?><button class="addEntryBtn small output-edit-process-step-action" data-process-id="<?php echo $cid; ?>" data-process-step-id="<?php echo $process_step['id']; ?>"><?php echo $formText_Add_output;?></button><?php } ?>
											</div>
											<div class="p_pageDetailsContent processStepContent">
												<?php
												$s_sql = "SELECT * FROM collecting_cases_process_steps_action WHERE collecting_cases_process_steps_id = ? ORDER BY sortnr ASC";
												$o_query = $o_main->db->query($s_sql, array(intval($process_step['id'])));
												...
												foreach($actions as $action) {
													...
													<table class="mainTable" width="100%" border="0" cellpadding="0" cellspacing="0">
											        	<tr>
											                ...
											                <td class="txt-value">
																...
																switch(intval($action['action'])) {
																	...
																	break;
																	case 2:
																		echo $formText_SendSms_output;
																	break;
																	case 3:
																		echo $formText_Call_output;
																	break;
																	case 4:
														...
														<tr>
															...
															<td class="txt-value">
																<?php
																echo $action['number_of_days_to_due_date'];
																?>
															</td>
														</tr>
														<?php if(intval($action['action']) == 1) { ?>
															<tr>
												                ...
												                <td class="txt-value">
																	...
																	$o_query = $o_main->db->query($s_sql, array(intval($action['collecting_cases_pdftext_id'])));
															...
															<tr>
												                ...
												                <td class="txt-value">
																	...
																	$o_query = $o_main->db->query($s_sql, array(intval($action['collecting_cases_emailtext_id'])));
																	$pdfText = $o_query ? $o_query->row_array() : array();
											        ...
											        <table class="mainTable btn-edit-table" width="100%" border="0" cellpadding="0" cellspacing="0">
											            <tr>
											                ...
											                <td class="btn-edit" colspan="2">
																<?php if($moduleAccesslevel > 10) { ?>
																	<button class="output-btn small output-edit-process-step-action editBtnIcon" data-process-id="<?php echo $cid; ?>" data-process-step-id="<?php echo $process_step['id']; ?>" data-process-step-action-id="<?php echo $action['id']; ?>"><span class="glyphicon glyphicon-pencil"></span></button>
																	<button class="output-btn small output-delete-process-step-action editBtnIcon" data-process-id="<?php echo $cid; ?>" data-process-step-id="<?php echo $process_step['id']; ?>" data-process-step-action-id="<?php echo $action['id']; ?>"><span class="glyphicon glyphicon-trash"></span></button>
