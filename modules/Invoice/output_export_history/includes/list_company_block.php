...
if ($invoice_accountconfig['activate_global_export']) {
    ...
    $exportScript = basename($exportScriptOC['exportScriptFolder']);
}
?>
        ...
        <?php foreach($export_list as $row): ?>
            ...
            <div class="gtable_row" data-href="<?php echo $s_edit_link;?>">
                ...
                <div class="gtable_cell c6">
                    <?php if(!$row['sentTime']): ?>
                        <a href="#" class="sendExport" data-export-id="<?php echo $row['id']; ?>" data-id-from="<?php echo $row['invoiceIdFrom']; ?>" data-id-to="<?php echo $row['invoiceIdTo']; ?>"><?php echo $formText_Send_output; ?></a>
                    <?php else: ?>
