...
if($moduleAccesslevel > 10) {
	if(isset($_POST['output_form_submit'])) {
        ...
        // Put file on FTP
        $ftpAddress = $ownercompany_data['exportFtpHost'];
        $ftpPort = $ownercompany_data['exportFtpPort'];
        $ftpLogin =  $ownercompany_data['exportFtpUsername'];
        $ftpPassword = $ownercompany_data['exportFtpPassword'];
        $ftpPath = rtrim($ownercompany_data['exportFtpPath'], '/') . '/';

        if ($ownercompany_data['exportFtpUseSSL']) {
	...
	<form class="output-form main" action="<?php print $_SERVER['PHP_SELF']."?pageID=".$_GET['pageID']."&accountname=".$_GET['accountname']."&companyID=".$_GET['companyID']."&caID=".$_GET['caID']."&module=".$module."&folderfile=output&folder=output_export_history&inc_obj=ajax&inc_act=sendExport";?>" method="post">
		...
		<div class="inner">
            ...
            <div class="line">
                ...
                <div class="lineInput">
                    <?php echo $ownercompany_data['exportFtpUsername']; ?>
                </div>
                <div class="clear"></div>
            </div>
            <div class="line">
                ...
                <div class="lineInput">
                    <?php echo $ownercompany_data['exportFtpHost']; ?>
                </div>
                <div class="clear"></div>
            </div>
            <div class="line">
                ...
                <div class="lineInput">
                    <?php echo $ownercompany_data['exportFtpPath']; ?>
                </div>
                <div class="clear"></div>
            </div>
        </div>
