...
if($moduleAccesslevel > 10) {
	if(isset($_POST['output_form_submit'])) {
        if ($invoiceId) {
            ...
            $emails = $_POST['email'];
            $emails = str_replace(array(";", chr(0xC2).chr(0xA0)), array(",", ''), $emails);
