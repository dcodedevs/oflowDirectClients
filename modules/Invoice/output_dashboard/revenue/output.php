...
if($s_inc_obj != "ajax")
{
    ...
    $currentYear = date("Y");
    ?>
    <div class="output-category-block" id="invoices_block">
        <div class="output-title-different"><?php echo $formText_Revenue_output." ";?>
			<select id="invoices_yearchanger" autocomplete="off">
        ...
        <div class="rs_box extra">
            <div class="output-content" id="invoices_info">
    ...
    <script type="text/javascript">
		$("#invoices_yearchanger").change(function(){
			refresh_invoices_dashboard();
		})
		function refresh_invoices_dashboard(){
			$('#invoices_info').html('<div class="loading"><div class="lds-ring"><div></div><div></div><div></div><div></div></div></div>');
	        //load latesupdates
	        $.ajax({
	            cache: false,
	            type: 'POST',
	            ...
	            data:  "fwajax=1&fw_nocss=1&year="+$("#invoices_yearchanger").val(),
	            success: function(json){
	                setTimeout(function() {
	                    $('#invoices_info').html(json.html);
	                }, 500);
	            }
	        }).fail(function() {
