...
function sys_get_field_config($file, $account_absolute_path, $databases)
{
	...
	foreach($variabSplit as $ab)
	{
		...
		$tempvariab->init($ubSplit[0],$ubSplit[1],$ubSplit[2],$ubSplit[3],$ubSplit[4],$ubSplit[5],$ubSplit[6],$ubSplit[9],$ubSplit[10],$ubSplit[11],$ubSplit[12],$ubSplit[13],$ubSplit[14],$ubSplit[15],$ubSplit[16]);
