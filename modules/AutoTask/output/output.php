...
$s_page_base_url = $_SERVER['PHP_SELF']."?pageID=".$_GET['pageID']."&accountname=".$_GET['accountname']."&companyID=".$_GET['companyID']."&caID=".$_GET['caID']."&module=".$module."&folderfile=output&folder=output";
...
$s_default_output_language = (($o_query && $o_row = $o_query->row()) ? $o_row->languageID : "");
...
$s_page_reload_url = $s_page_base_url;
