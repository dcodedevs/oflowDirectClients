...
{
	$b_add = TRUE;
	// Check if task is handled 1 - Queued, 2 - Running, 3 - Completed
	...
	{
		$o_main->db->query("INSERT INTO auto_task_log SET auto_task_id = '".$o_main->db->escape_str($v_row['id'])."', status = 1, created = NOW()");
		$v_item = array();
