...
?><div class="leftBlock" style="width:40%; float:left;">
	...
	<select <?php echo $field_attributes;?> id="<?php echo $field_ui_id;?>d1" onChange="getModuleData_<?php echo $field_ui_id;?>($(this).val());"<?php echo ($field[10]==1||$access<10||$mode[1]==1?" disabled":"");?>>
