<script type="text/javascript">
    ...
    **/
    function ajaxCall(includeFile, data, callback, showLoader, failover, customModuleData) {
        ...
        var moduleFolder = "output_view_table";
        var moduleFile = "";
        var abortable = 0;
        var abortableString = '';
        ...
        $.ajax({
            ...
            type: 'POST',
            dataType: 'json',
            url: '<?php echo $_SERVER['PHP_SELF']."?pageID=".$_GET['pageID']."&accountname=".$_GET['accountname']."&companyID=".$_GET['companyID']."&caID=".$_GET['caID']."&module="?>'+moduleName+abortableString+'<?php echo "&folderfile=output&folder="?>'+moduleFolder+'<?php echo "&inc_obj=ajax&inc_act="; ?>' + moduleFile,
            data: ajaxData,
