...
if($v_employee_basisconfig['activate_persons_tab']){
	$v_include_default = 'person_list';
}
if($v_employee_accountconfig['default_tab'] != "") {
	if(in_array($v_employee_accountconfig['default_tab'], $v_include)){
		$v_include_default = $v_employee_accountconfig['default_tab'];
	}
}
if($v_include_default == ""){
	if($v_employee_basisconfig['activate_people_owncompany_tab']){
		$v_include_default = 'people_owncompany';
	}
}
