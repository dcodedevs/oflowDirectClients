...
$(document).ready(function() {
  ...
  function fwaFileuploadInit() {
    ...
    $('#<?php echo $fwaFileuploadConfig['id'];?>_upload').unbind().fileupload({
      url: '<?php echo '../modules/'.$fwaFileuploadConfig['module_folder'].'/output/includes/fileupload7/ajax_upload.php?param_name='.$fwaFileuploadConfig['id'].'_files'; ?>',
      dataType: 'json',
      formData: {
      ...
      add: function (e, data) {
        if(imagesToProcess.length == 0){//hardcoded single image upload
