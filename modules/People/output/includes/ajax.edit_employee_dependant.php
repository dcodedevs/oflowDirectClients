...
if($moduleAccesslevel > 10)
{
	if(isset($_POST['output_form_submit']))
	{
		if($_POST['cid'] > 0) {
			...
			dependants_phone = ?
			WHERE id = ?";
			$o_main->db->query($s_sql, array($variables->loggID, $_POST['dependants_name'], $_POST['dependants_phone'], $_POST['cid']));
...
<div class="popupform">
	...
	<form class="output-form main" action="<?php print $_SERVER['PHP_SELF']."?pageID=".$_GET['pageID']."&accountname=".$_GET['accountname']."&companyID=".$_GET['companyID']."&caID=".$_GET['caID']."&module=".$module."&folderfile=output&folder=output&inc_obj=ajax&inc_act=edit_employee_dependant";?>" method="post">
		...
		<div class="inner">
			<div class="line">
			<div class="lineTitle"><?php echo $formText_DependantName_Output; ?></div>
			<div class="lineInput"><input class="popupforminput botspace" name="dependants_name" type="text" value="<?php echo $v_data->dependants_name;?>" autocomplete="off"></div>
			<div class="clear"></div>
			</div>
			<div class="line">
			<div class="lineTitle"><?php echo $formText_DependantPhone_Output; ?></div>
			<div class="lineInput"><input class="popupforminput botspace" name="dependants_phone" type="text" value="<?php echo $v_data->dependants_phone;?>" autocomplete="off"></div>
			<div class="clear"></div>
			</div>
