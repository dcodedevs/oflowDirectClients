...
if($moduleAccesslevel > 10)
{
	if(isset($_POST['output_form_submit']))
	{
		if(isset($_POST['cid']) && $_POST['cid'] > 0) {
			...
			WHERE id = ?";
			$o_main->db->query($s_sql, array($variables->loggID, $_POST['external_employee_id'], $_POST['cid']));
...
<div class="popupform">
	...
	<form class="output-form main" action="<?php print $_SERVER['PHP_SELF']."?pageID=".$_GET['pageID']."&accountname=".$_GET['accountname']."&companyID=".$_GET['companyID']."&caID=".$_GET['caID']."&module=".$module."&folderfile=output&folder=output&inc_obj=ajax&inc_act=edit_employee_code";?>" method="post">
		...
		<div class="inner">
			<div class="line">
				<div class="lineTitle"><?php echo $formText_EmployeeCode_Output; ?></div>
				<div class="lineInput">
					<input type="text" class="popupforminput botspace" name="external_employee_id" value="<?php echo $v_data->external_employee_id; ?>" autocomplete="off">
				</div>
				<div class="clear"></div>
			</div>
		</div>
