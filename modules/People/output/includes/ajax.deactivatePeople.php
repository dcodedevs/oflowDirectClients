...
if($accessElementAllow_AddEditDeletePeople){
	...
	if(isset($_POST['output_form_submit']))
	{
		...
		<div class="profileEditForm popupform">
			...
			<form class="output-form" action="<?php print $_SERVER['PHP_SELF']."?pageID=".$_GET['pageID']."&accountname=".$_GET['accountname']."&companyID=".$_GET['companyID']."&caID=".$_GET['caID']."&module=".$module."&folderfile=output&folder=output&inc_obj=ajax&inc_act=deactivatePeople";?>" method="post">
			...
			<div class="confirm-text">
				<?php echo $formText_AreYouSureYouWantToDeactivateThisPerson_Output;?> (<?php echo $formText_AccessWillBeDeleted_Output;?>)
				<br/>
			...
			<div class="popupformbtn">
				...
				<input type="submit" class="fw_button_color" name="sbmbtn" value="<?php echo $formText_Deactivate_Output; ?>">
			</div>
		  </form>
		</div>
		<style>
