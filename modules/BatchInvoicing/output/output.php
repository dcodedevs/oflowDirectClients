...
$v_include = array("list", "history", "ajax");
...
if($s_inc_obj != "ajax")
{
	...
	<div id="output-content-container">
		<?php
		if(is_file(__DIR__."/".$s_inc_obj.".php")) include(__DIR__."/".$s_inc_obj.".php");
		?>
	</div>
	<?php
} else {
	...
	if(is_file(__DIR__."/".$s_inc_obj.".".$s_inc_act.".php")) include(__DIR__."/".$s_inc_obj.".".$s_inc_act.".php");
}
