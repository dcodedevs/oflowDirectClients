...
$(document).ready(function() {
   ...
   */
   <?php
   $fileuploadLink = '../modules/'.$fwaFileuploadConfig['module_folder'].'/output/includes/fileupload_popup/ajax_upload.php?param_name='.$fwaFileuploadConfig['id'].'_files&file_type='.$fwaFileuploadConfig['file_type'];
