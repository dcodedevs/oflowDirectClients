    ...
    <?php foreach($latestUpdates as $latestUpdate) {
        ...
        <div class="latest_update_row">
            ...
            foreach($images as $file){
                ...
                {
                    $fileUrl = $extradomaindirroot.'/../'.$file[1][0].'?caID='.$_GET['caID'].'&table=latestupdates&field=file&ID='.$latestUpdate['id']."&".$fileAddition;
                } else {
