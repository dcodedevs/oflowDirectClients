<script type="text/javascript">
     ...
     */
     function ajaxCall(includeFile, data, callback, showLoader, failover) {
    ...
    function loadView(includeFile, data) {
        ...
        // Url params
        var urlParams = $.param(ajaxData);

        <?php if($s_group_id > 0) { ?>
            moduleName = "GroupPage";
            moduleFolder = "output";
            moduleFile = "<?php echo strtolower($module)?>"
        <?php } ?>
        // Load view
