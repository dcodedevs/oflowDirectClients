...
$v_include = array(
	...
	"list",
    "details",
    "duplicated_fee_reset_list",
    "tab_sorting_log_page"
);

$v_include_default = 'list';


$baselink = $_SERVER['PHP_SELF']."?pageID=".$_GET['pageID']."&accountname=".$_GET['accountname']."&companyID=".$_GET['companyID']."&caID=".$_GET['caID']."&module=".$module."&folderfile=output&folder=output_creditor";
