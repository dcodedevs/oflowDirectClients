...
$o_query = $o_main->db->get('invoice_accountconfig');
...
if(!isset($_POST['output_form_submit']) && isset($error_msg) && sizeof($error_msg)>0)
{
	$print = "";
