		...
		if(array_key_exists($fieldName."_name",$_POST))
		{
			...
			foreach($_POST[$fieldName."_name"] as $key => $item)
			{
				...
				if(strpos($item,"process|") !== false)
				{
					...
					{
						$delete_file = true;
						$file_obj[1] = rawurldecode($file_obj[1]);
...
$videoArray[3] = $_POST[$fieldName.'_type'];
if('youtube' == $_POST[$fieldName.'_type'])
{
	$videoArray[0] = $_POST[$fieldName];
}
if('vimeo' == $_POST[$fieldName.'_type'])
{
	$videoArray[0] = $_POST[$fieldName.'_vimeo'];
}
if('file' == $_POST[$fieldName.'_type'])
{
    $videoArray[0] = $files;
	$videoArray[2] = $images;
}
