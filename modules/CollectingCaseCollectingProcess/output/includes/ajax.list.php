...
<?php if (!$rowOnly) { ?>
	...
	<div class="gtable" id="gtable_search">
	    <div class="gtable_row">
	        ...
	        <div class="gtable_cell gtable_cell_head"><?php echo $formText_AvailableFor_output;?></div>
	    </div>
<?php } ?>
    <?php
        ...
        <?php
      	// Show default columns
      	 ?>
	        ...
	        <div class="gtable_cell"><?php if($v_row['available_for'] == 1) {
                echo $formText_Person_output;
            } else if($v_row['available_for'] == 2) {
                 echo $formText_Company_output;
            } else if($v_row['available_for'] == 3) {
                 echo $formText_PersonAndCompany_output;
            }?></div>
        </div>
    <?php } ?>
	<?php if (!$rowOnly) { ?>
