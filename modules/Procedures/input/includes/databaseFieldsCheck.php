...
include_once(__DIR__.'/fnctn_get_tables.php');
include_once(__DIR__.'/fnctn_get_table_fields.php');
include_once(__DIR__.'/fnctn_get_table_fields_from_db.php');
include_once(__DIR__.'/fnctn_get_table_fields_structure.php');
include_once(__DIR__.'/fn_check_table_system_fields.php');
include_once(__DIR__.'/fn_get_table_indexes.php');
include_once(__DIR__.'/fn_get_table_indexes_from_db.php');
...
{
	check_table_system_fields($s_table,__DIR__.'/../../');
...
foreach($table_names as $s_table)
{
	if(strlen($s_table))
	{
		...
		if(!$o_main->db->table_exists($s_table))
		{
			...
			$s_sql_create = 'CREATE TABLE '.$o_main->db_escape_name($s_table).' ( '.$s_sql_field.' , PRIMARY KEY(id)'.$s_sql_index.')';
			if(isset($_GET['debug']))
			{
				print ('<br />');
				print ($s_sql_create);
