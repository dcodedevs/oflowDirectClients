...
foreach($items as $key=>$item)
{
	...
	print $value; ?><input onClick="$('#<?php echo $field_ui_id;?>').val($(this).val())" type="radio" value="<?php echo $a;?>" <?php echo ($field[6][$langID]==$a?" checked":"").($access<10||$field[10]==1?" disabled":"");?> style="width:20px;" />&nbsp;&nbsp;&nbsp;<?php
}
?>
