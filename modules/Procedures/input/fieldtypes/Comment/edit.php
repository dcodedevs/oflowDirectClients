<div class="field_<?php echo $field_ui_id;?>">
	...
	<a class="add script" href="javascript:;" onClick="add_<?php echo $field_ui_id;?>();"><img border="0" src="<?php echo $extradir;?>/input/fieldtypes/<?php echo $field[4];?>/images/add.gif" /> <?php echo $formText_Add_Types;?></a>
	<?php } ?>
	...
	if($field[6][$langID] != "")
	{
		...
		foreach($data as $obj)
		{
			...
			<tr>
				...
				<?php if($access >= 10 and $field[10] != 1) { ?>
				<td class="second"><a class="remove script" href="javascript:;" onClick="remove_<?php echo $field_ui_id;?>('<?php echo $i;?>');" title="<?php echo $formText_delete_fieldtype;?>"><img border="0" src="<?php echo $extradir;?>/input/fieldtypes/<?php echo $field[4];?>/images/cross.png"/></a>
				</td>
				<?php } ?>
			</tr>
			</table>
...
.field_<?php echo $field_ui_id;?> .add img { vertical-align: middle;}
</style>