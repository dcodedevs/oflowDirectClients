...
<?php if (!$rowOnly) { ?>
	...
	<div class="gtable" id="gtable_search">
	    ...
	    <div class="gtable_row">
	        ...
	        <div class="gtable_cell gtable_cell_head c1"><?php echo $formText_Bookaccount_output;?></div>
	        <div class="gtable_cell gtable_cell_head rightAlign"><?php echo $formText_Amount_output;?></div>
	    </div>
        <?php } else if($list_filter == "settlements") {?>
            <div class="gtable_row">
    	        <div class="gtable_cell gtable_cell_head c1"><?php echo $formText_Date_output;?></div>
	        	<div class="gtable_cell gtable_cell_head c1"><?php echo $formText_CreditorLedger_Output;?></div>
    	        <div class="gtable_cell gtable_cell_head c1"><?php echo $formText_DebitorLedger_Output;?></div>
    	        <div class="gtable_cell gtable_cell_head c1"><?php echo $formText_CollectingCompanyLedger_Output;?></div>
...
<?php } ?>
    ...
    foreach($customerList as $v_row){
        if($list_filter == "payments") {
            ...
            $o_query = $o_main->db->query($s_sql, array($v_row['case_id']));
            ...
            $summaryAmount+=$v_row['amount'];
          	 ?>
                ...
                <div class="gtable_cell c1"><?php echo $v_row['bookaccountName'];?></div>
        ...
        <?php } else if($list_filter == "settlements") {
			...
			$s_sql = "SELECT cmv.*, cmv.case_id FROM cs_mainbook_voucher cmv
			WHERE IFNULL(cmv.settlement_id, 0) = ?";
            ...
            <div class="gtable_row output-click-helper"  data-href="<?php echo $s_edit_link; ?>">
    	        ...
    	        <div class="gtable_cell"><?php echo number_format($creditorLedgerSum, 2, ",", " "); ?></div>
    	        <div class="gtable_cell"><?php echo number_format($debitorLedgerSum, 2, ",", " "); ?></div>
    	        <div class="gtable_cell"><?php echo number_format($collectingLedgerSum, 2, ",", " "); ?></div>
    	        <div class="gtable_cell">
