				...
				$(".list_content .searchField").keyup(function(){
					...
					delay(function(){   
						...
						$.ajax({
							...
							data: {soker: '<?php echo json_encode($o_soker_main); ?>',filter1: filter1, filter2:filter2, filter3: filter3, search: searchText, searchFieldName: "<?php echo $searchFieldName?>", search_method: "<?php echo $e_search_method?>", searchType: "<?php echo $searchType?>", 
				...
				<script type="text/javascript">
					...
					function menu_filter_update_list(filter1, filter2, filter3)
					{
						...
						$.ajax({
							...
							data: {
								soker: '<?=json_encode($o_soker_main); ?>', filter1: filter1, filter2: filter2, filter3: filter3, search_method: "<?php echo $e_search_method?>",
