...
.fwaFileupload_FilesList_Files .thumbnail {
...
.fwaFileupload_FilesList_Files .thumbnailOverlay {
    position: absolute;
    top: 0;
    left: 0;
    bottom: 0;
...
.fwaFileupload_FilesList_Files .item:hover .thumbnailOverlay {
    display: block;
}
.fwaFileupload_FilesList_Files .thumbnail img {
    width: 100%;
}
...
#fw_account.alternative .fw_info_message_wraper {
    z-index: 100000;
}
.fancybox-overlay {
    z-index: 100001;
...
.fwaFileupload_FilesList_Files label {
    font-weight: normal;
}
</style>
