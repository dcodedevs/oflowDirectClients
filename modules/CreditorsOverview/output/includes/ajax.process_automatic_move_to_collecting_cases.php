...
if($_POST['output_form_submit']) {
	...
	if(count($_POST['transaction_ids']) > 0) {
		include(__DIR__."/process_scripts/handle_move_to_collecting.php");
		return;
	} else {
