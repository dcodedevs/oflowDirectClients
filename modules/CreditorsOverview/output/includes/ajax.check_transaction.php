	...
	if(isset($_POST['output_form_submit'])) {
        if($_POST['transaction_nr'] != "") {
            ...
            if($api->error == "") {
                ...
                // $transactionData['TransactionNoStart'] = $_POST['transaction_nr'];
                // $transactionData['TransactionNoEnd'] = $_POST['transaction_nr'];
                $transactionData['InvoiceNo'] = 100254;
...
<div class="popupform popupform-<?php echo $creditor_id;?>">
	...
	<form class="output-form main" action="<?php print $_SERVER['PHP_SELF']."?pageID=".$_GET['pageID']."&accountname=".$_GET['accountname']."&companyID=".$_GET['companyID']."&caID=".$_GET['caID']."&module=".$module."&folderfile=output&folder=output&inc_obj=ajax&inc_act=check_transaction";?>" method="post">
		...
		<div class="inner">
            ...
            <div class="line">
				<div class="lineTitle"><?php echo $formText_TransactionNr_output; ?></div>
				<div class="lineInput">
					<input type="text" class="popupforminput botspace" autocomplete="off" name="transaction_nr" value="<?php echo $_POST['transaction_nr']?>" required/>
				</div>
				<div class="clear"></div>
			</div>
