...
$o_query = $o_main->db->query($sql, array($process['process_step_type_id']));
$step_type = $o_query ? $o_query->row_array() : array();

$sql = "SELECT * FROM collecting_cases_collecting_process WHERE id = ?";
$o_query = $o_main->db->query($sql, array($process['collecting_process_move_to']));
$collecting_process = $o_query ? $o_query->row_array() : array();

$sql = "SELECT * FROM collecting_cases_collecting_process WHERE id = ?";
$o_query = $o_main->db->query($sql, array($process['alternative_process_move_to']));
$alternative_process = $o_query ? $o_query->row_array() : array();
?>
			...
			<div class="p_pageContent">
				...
				<div class="p_pageDetailsTitle">
					<div class="" style="float: left">
						...
						<?php
						if($process['fee_level_name'] != ""){
							echo $process['fee_level_name']. " " .$step_type['name'];
						} else {
							echo $process['name'];
						} ?>
						...
						<div><b><?php echo $formText_DaysAfterDueDate_output;?></b>: <?php echo $process['days_after_due_date_move_to_collecting']?></div>
						<div><b><?php echo $formText_ProccessToMoveTo_output;?></b>: <?php echo $collecting_process['name']?></div>
						<div><b><?php echo $formText_AlternativeProccessToMoveTo_output;?></b>: <?php echo $alternative_process['name']?></div>
					</div>
					...
					<div class="">
						<div class="p_contentBlock dropdown_content noTopPadding">
							...
							foreach($process_steps as $process_step) {
						        ...
						        $o_query = $o_main->db->query($s_sql, array($process_step['id']));
									...
									<div class="processStepDetails">
										<table class="mainTable" width="100%" border="0" cellpadding="0" cellspacing="0">
											...
											<tr>
								                ...
								                <td class="txt-value">
								                	<?php
													echo $process_step['days_after_due_date'];
													?>
								                </td>
								            </tr>
											<tr>
											...
											<tr>
												<td class="txt-label"><?php echo $formText_ReminderTransactionText_Output;?></td>
												<td class="txt-value">
													<?php
													echo $process_step['reminder_transaction_text'];
													?>
												</td>
											</tr>
											<tr>
												<td class="txt-label" style="vertical-align: top;"><?php echo $formText_ReminderAmountFixed_Output;?></td>
												<td class="txt-value">
													<?php echo $process_step['reminder_amount'];?>
												</td>
											</tr>
											<tr>
												<td class="txt-label" style="vertical-align: top;"><?php echo $formText_ReminderAmountSteps_Output;?></td>
												<td class="txt-value">
													<?php
													foreach($fees as $fee) {
														...
														<div class="fee_preview_block">
															<div class="line">
												        		...
												        		<div class="lineInput">
																	<?php echo $fee['mainclaim_from_amount'];?>
											                    </div>
												        		<div class="clear"></div>
												    		</div>
															<div class="line">
											...
											<tr>
												<td class="txt-label"><?php echo $formText_AddFee_Output;?></td>
												<td class="txt-value">
													<?php
													if(!$process_step['doNotAddFee']) {
											...
											<tr>
												<td class="txt-label"><?php echo $formText_AddInterest_Output;?></td>
												<td class="txt-value">
													<?php
													if(!$process_step['doNotAddInterest']) {
														echo $formText_Yes_output;
													} else {
														echo $formText_No_output;
													}
											...
											<tr>
												<td class="txt-label"><?php echo $formText_ShowCollectingCompanyLogo_Output;?></td>
												<td class="txt-value">
													<?php
											...
											<tr>
												<td class="txt-label"><?php echo $formText_EditableReminderTextForCustomer_Output;?></td>
												<td class="txt-value">
													<?php
													if($process_step['editable_reminder_text_for_customer']) {
														echo $formText_No_output;
													} else {
														echo $formText_Yes_output;
													}
...
<style>
	...
	.fee_preview_block .lineTitle {
		float: left;
		width: 30%;
	}
	.fee_preview_block .lineInput {
		float: left;
		width: 70%;
	}
</style>
