...
$sql = "SELECT * FROM collecting_company_cases_continuing_process_steps WHERE appear_in_legal_step_handling = 1";
		...
		<div class="p_content">
			<div class="p_pageContent">
				<div class="p_pageContent_title">
					<?php echo $formText_CasesRequiringLegalHandling_output." (".$legal_count.")";?>
				</div>
				<div class="gtable">
