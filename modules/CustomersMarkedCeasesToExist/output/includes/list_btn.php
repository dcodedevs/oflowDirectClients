...
if($moduleAccesslevel > 10)
{
	...
	$o_query = $o_main->db->query($s_sql, array("modules/CustomersMarkedCeasesToExist/autotask_check_for_ceases_to_exist/run.php"));
	...
	<div class="check_for_bankruptcy btnStyle">
		<div class="plusTextBox active">
			...
			<div class="text"><?php echo $formText_CheckForBankruptCustomers_Output; ?></div>
		</div>
		<div class="clear"></div>
	</div>
    <?php*/
