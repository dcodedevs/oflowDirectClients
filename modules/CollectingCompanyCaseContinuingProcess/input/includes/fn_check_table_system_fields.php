<?php
if(!function_exists('check_table_system_fields')){
function check_table_system_fields($table, $pre_path, $module = '')
{
	...
	if(is_file($file))
	{
		...
		if(is_file($file))
		{
			...
			*/
			if($o_main->multi_acc && strpos($variablesBase,'"account_id¤') === false && ('_basisconfig' != substr($table,-12)))
			{
				$b_save_file = true;
				$variablesBase .= ',"account_id¤'.$table.'account_id¤{$formText_AccountId_input}¤'.$table.'¤AccountId¤¤¤¤¤1¤0¤¤1¤1¤0¤¤¤"';
			}
			
			/*
			** Check app_id field
			*/
			if($o_main->multi_acc && strpos($variablesBase,'"app_id¤') === false && ('_basisconfig' == substr($table,-12)))
			{
				$b_save_file = true;
				$variablesBase .= ',"app_id¤'.$table.'app_id¤{$formText_AppId_input}¤'.$table.'¤AppId¤¤¤¤¤1¤0¤¤1¤1¤0¤¤¤"';
			}
