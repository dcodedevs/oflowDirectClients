...
$sql = "SELECT * FROM collecting_company_cases_continuing_process WHERE id = $cid";
$o_query = $o_main->db->query($sql);
								...
								<div class="processStepBlock">
									<div class="processStepDetails">
										<table class="mainTable" width="100%" border="0" cellpadding="0" cellspacing="0">
											...
											<tr>
								                <td class="txt-label"><?php echo $formText_CreateLetter_Output;?></td>
								                <td class="txt-value">
								                	<?php 
													if($process_step['create_letter']){ echo $formText_Yes_output; } else { echo $formText_No_output;}
													?>
								                </td>
								            </tr>
											...
											<tr>
												<td class="txt-label"><?php echo $formText_AppearInLegalStepHandling_output;?></td>
												<td class="txt-value">
													<?php
													if($process_step['appear_in_legal_step_handling']){ echo $formText_Yes_output; } else { echo $formText_No_output;}
													?>
												</td>
											</tr>									
											<tr>
												<td class="txt-label"><?php echo $formText_AppearInCallDebitorStepHandling_output;?></td>
												<td class="txt-value">
													<?php
													if($process_step['appear_in_call_debitor_step_handling']){ echo $formText_Yes_output; } else { echo $formText_No_output;}
													?>
												</td>
											</tr>
								        </table>
