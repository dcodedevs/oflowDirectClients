...
<?php } ?>
	<div class="resultOnlyWrapper">
		<table class="table table-striped table-condensed">
			...
			<tr>
				<td>
					<a href="#" class="tablescript" data-employeeid="<?php echo $employee['id']?>" data-employeename="<?php echo $employee['name'];?>"><?php echo $employee['name'];?></a>
				</td>
			</tr>
			<?php } ?>
			</tbody>
...
<script type="text/javascript">
	$(".employees .tablescript").unbind("click").bind("click", function(e){
		...
		if(employeeID > 0){
			$(".output-form #articleId").val(employeeID);
			$(".output-form .selectArticle").html(employeeName);
