		...
		if($activateSeo == "1")
		{
				...
				if($seoUrlEditType == 2)
				{
					...
					?><div>
						...
						<div class="onefield sys-seo-input">
							...
							<input type="text" id="<?php echo $obj_ui_id;?>" name="<?php echo $submodule.'seourl'.$key;?>" value="<?php echo htmlspecialchars($value);?>">
						</div>
					</div><?php
					...
					?><div>
						...
						<div class="onefield sys-seo-input input-group">
							...
							<input type="hidden" id="<?php echo $obj_ui_id;?>" name="<?php echo $submodule.'seourl'.$key;?>" value="<?php echo htmlspecialchars($value);?>">
						</div>
					</div><?php
				} else {
					// Url not editable
					...
					<input type="hidden" id="<?php echo $obj_ui_id;?>" name="<?php echo $submodule.'seourl'.$key;?>" value="<?php echo htmlspecialchars($value);?>"><?php
				}
			...
			function sys_updateSeoUrl(seoUrlField, languageID)
			{
				...
				$.ajax({
					...
					cache: false,
					data: { id: '<?php echo $ID;?>', table: '<?php echo $submodule;?>', menulevelID: _menulevelID, data : $(seoUrlField+'<?php echo ($seoUrlEditType < 2 ? 'content':'');?>').val(), languageID: languageID, allowEmpty: '<?php echo ($enableEmptySeoUrl==1?1:0);?>', seoUrlEditType: '<?php echo $seoUrlEditType;?>', seoUrlMenuSplitter: '<?php echo $seoUrlMenuSplitter;?>' },
					success: function(data) {
