...
foreach($skrivKunders as $skrivKunder) {
    ...
    if ($roundingCorrection != 0) {
        echo mb_convert_encoding("GBAT10;".$teller.";".sendIt(10,$fakturaDato).";1;".$tperiode.";".$fakturaAar.";".$roundingAccountNr.";0;".$roundingCorrection.";0;0;;".$address.";"
        .$postalNumber.";".$city.";".$skrivKunder['fakturaID'].";;;;;".$skrivKunder['kundeID']." ".$skrivKunder['name']." ".$skrivKunder['fakturaID'].";".$skrivKunder['kundeID']." "
        .$skrivKunder['name']." ".$skrivKunder['fakturaID'].";;;;;T;".$roundingCorrection."\r\n", 'ISO-8859-1', 'UTF-8');
    }
    ...
    .str_replace("-","",$forfallsDato).";;;".$skrivKunder['kundeID']." ".$skrivKunder['name']." ".$skrivKunder['fakturaID'].";;;;;;T;".$skrivKunder['totalInclTax']."\r\n", 'ISO-8859-1', 'UTF-8');
