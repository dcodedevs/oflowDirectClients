...
foreach($skrivKunders as $skrivKunder) {
    ...
    foreach($orderList as $order){
        ...
        $invoiceLine = array();
        $invoiceLine['output'] = "GBAT10;TELLER_REPLACE;".sendIt(10,$fakturaDato).";1;".$tperiode.";".$fakturaAar.";".$order['bookaccountNr'].";".$order['vatCode'].";".($order['gross'] * -1).";0;0;;".$address.";".$postalNumber.";".$city.";".$skrivKunder['fakturaID'].";;;;;".$skrivKunder['kundeID']." ".$skrivKunder['name']." ".$skrivKunder['fakturaID'].";".$skrivKunder['kundeID']." ".$skrivKunder['name']." ".$skrivKunder['fakturaID'].";;".$projectData['projectnumber'].";".$order['department_for_accounting_code'].";;T;".($order['gross'] * -1)."\r\n";
    ...
    if($settingsData['activatePeriodization']){
        foreach($orderList as $order){
            if(intval($order['periodization']) > 0){
                ...
                if(!$dontAddLines){
                    $invoiceLine = array();
                    $invoiceLine['output'] =  "GBAT10;TELLER_REPLACE;".sendIt(10,$fakturaDato).";1;".$tperiode.";".$fakturaAar.";".$order['bookaccountNr'].";0;".round(($order['gross'] / ((100 + $order['vatPercent'])/100)), 2).";0;0;;".$address.";".$postalNumber.";".$city.";".$skrivKunder['fakturaID'].";;;;;".$skrivKunder['kundeID']." ".$skrivKunder['name']." ".$skrivKunder['fakturaID'].";".$skrivKunder['kundeID']." ".$skrivKunder['name']." ".$skrivKunder['fakturaID'].";;".$projectData['projectnumber'].";".$order['department_for_accounting_code'].";;T;".round(($order['gross'] / ((100 + $order['vatPercent'])/100)), 2)."\r\n";
                    $invoiceLine['teller'] = $teller;
                    $invoiceLine['date'] = sendIt(10,$fakturaDato);
                    array_push($invoiceLines, $invoiceLine);
