...
foreach($skrivKunders as $skrivKunder) {
    ...
    $o_query = $o_main->db->query("SELECT orders.*, customer_collectingorder.department_for_accounting_code FROM orders JOIN customer_collectingorder ON customer_collectingorder.id = orders.collectingorderId WHERE customer_collectingorder.invoiceNumber = ?", array($skrivKunder['invoiceID']));
    ...
    foreach($orderList as $order){
        ...
        $invoiceLine = array();
        $invoiceLine['output'] = "GBAT10;TELLER_REPLACE;".sendIt(10,$fakturaDato).";2;".$tperiode.";".$fakturaAar.";".$order['bookaccountNr'].";".$order['vatCode'].";".($order['gross'] * -1).";0;0;;".$address.";".$postalNumber.";".$city.";".$skrivKunder['fakturaID'].";;;;;".$skrivKunder['kundeID']." ".$skrivKunder['name']." ".$skrivKunder['fakturaID'].";".$skrivKunder['kundeID']." ".$skrivKunder['name']." ".$skrivKunder['fakturaID'].";;".$projectData['projectnumber'].";".$order['department_for_accounting_code'].";;T;".($order['gross'] * -1)."\r\n";
    ...
    $invoiceLine['output'] = "GBAT10;TELLER_REPLACE;".sendIt(10,$fakturaDato).";2;".$tperiode.";".$fakturaAar.";".$roundingAccountNr2.";0;".$skrivKunder['totalInclTax'].";".$skrivKunder['kundeID'].";0;".$skrivKunder['name'].";".$address.";".$postalNumber.";".$city.";".$skrivKunder['fakturaID'].";".$skrivKunder['kidNumber'].";".str_replace("-","",$forfallsDato).";;;".$skrivKunder['kundeID']." ".$skrivKunder['name']." ".$skrivKunder['fakturaID'].";;;;;;T;".$skrivKunder['totalInclTax']."\r\n";
    $invoiceLine['teller'] = $teller;
    $invoiceLine['date'] = sendIt(10,$fakturaDato);
    array_push($invoiceLines, $invoiceLine);
    ...
    if($settingsData['activatePeriodization']){
        foreach($orderList as $order){
            if(intval($order['periodization']) > 0){
                ...
                if(!$dontAddLines){
                    $invoiceLine = array();
                    $invoiceLine['output'] =  "GBAT10;TELLER_REPLACE;".sendIt(10,$fakturaDato).";2;".$tperiode.";".$fakturaAar.";".$order['bookaccountNr'].";0;".round(($order['gross'] / ((100 + $order['vatPercent'])/100)), 2).";0;0;;".$address.";".$postalNumber.";".$city.";".$skrivKunder['fakturaID'].";;;;;".$skrivKunder['kundeID']." ".$skrivKunder['name']." ".$skrivKunder['fakturaID'].";".$skrivKunder['kundeID']." ".$skrivKunder['name']." ".$skrivKunder['fakturaID'].";;".$projectData['projectnumber'].";".$order['department_for_accounting_code'].";;T;".round(($order['gross'] / ((100 + $order['vatPercent'])/100)), 2)."\r\n";
                    $invoiceLine['teller'] = $teller;
                    $invoiceLine['date'] = sendIt(10,$fakturaDato);
                    array_push($invoiceLines, $invoiceLine);

                    $invoiceLine = array();
                    $invoiceLine['output'] =  "GBAT10;TELLER_REPLACE;".sendIt(10,$fakturaDato).";2;".$tperiode.";".$fakturaAar.";".$settingsData['balancePeriodizationAccountcode'].";0;".round(($order['gross'] / ((100 + $order['vatPercent'])/100) * -1), 2).";0;0;;".$address.";".$postalNumber.";".$city.";".$skrivKunder['fakturaID'].";;;;;".$skrivKunder['kundeID']." ".$skrivKunder['name']." ".$skrivKunder['fakturaID'].";".$skrivKunder['kundeID']." ".$skrivKunder['name']." ".$skrivKunder['fakturaID'].";;".$projectData['projectnumber'].";".$order['department_for_accounting_code'].";;T;".round(($order['gross'] / ((100 + $order['vatPercent'])/100) * -1), 2)."\r\n";
                    $invoiceLine['teller'] = $teller;
                    $invoiceLine['date'] = sendIt(10,$fakturaDato);
                    array_push($invoiceLines, $invoiceLine);
                }
                    ...
                    if(!$dontAddLines){
                        ...
                        foreach($periodizationMonthsArray as $key => $periodizationMonthsSingle){
                            ...
                            if($date[1] != "" && $date[0] != ""){
                                ...
                                $invoiceLine = array();
                                $invoiceLine['output'] = "GBAT10;TELLER_REPLACE;".sendIt(10,$fakturaDato2).";2;".$tperiode2.";".$fakturaAar2.";".$order['bookaccountNr'].";0;".($currentIncome*-1).";0;0;;".$address.";".$postalNumber.";".$city.";".$skrivKunder['fakturaID'].";;;;;".$skrivKunder['kundeID']." ".$skrivKunder['name']." ".$skrivKunder['fakturaID'].";".$skrivKunder['kundeID']." ".$skrivKunder['name']." ".$skrivKunder['fakturaID'].";;".$projectData['projectnumber'].";".$order['department_for_accounting_code'].";;T;".($currentIncome*-1)."\r\n";
                                $invoiceLine['teller'] = $teller;
                                $invoiceLine['date'] = sendIt(10,$fakturaDato2);
                                array_push($invoiceLines, $invoiceLine);

                                $invoiceLine = array();
                                $invoiceLine['output'] = "GBAT10;TELLER_REPLACE;".sendIt(10,$fakturaDato2).";2;".$tperiode2.";".$fakturaAar2.";".$settingsData['balancePeriodizationAccountcode'].";0;".($currentIncome).";0;0;;".$address.";".$postalNumber.";".$city.";".$skrivKunder['fakturaID'].";;;;;".$skrivKunder['kundeID']." ".$skrivKunder['name']." ".$skrivKunder['fakturaID'].";".$skrivKunder['kundeID']." ".$skrivKunder['name']." ".$skrivKunder['fakturaID'].";;".$projectData['projectnumber'].";".$order['department_for_accounting_code'].";;T;".($currentIncome)."\r\n";
                                $invoiceLine['teller'] = $teller;
                                $invoiceLine['date'] = sendIt(10,$fakturaDato2);
                                array_push($invoiceLines, $invoiceLine);
                            }
    ...
    foreach($invoiceLines as $invoiceLine) {
        echo mb_convert_encoding(str_replace("TELLER_REPLACE", $invoiceLine['teller'], $invoiceLine['output']), 'ISO-8859-1', 'UTF-8');
    }
