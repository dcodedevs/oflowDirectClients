...
if($s_inc_obj != "ajax")
{
	...
	if(isset($_GET['exportBtn'])){
		...
		if(is_string($_GET['exportBtn'])) $s_inc_folder = $_GET['exportBtn'];
		if(is_file(__DIR__."/includes/exportScripts/".$s_inc_folder."/".$s_inc_obj.".".$s_inc_act.".php")) include(__DIR__."/includes/exportScripts/".$s_inc_folder."/".$s_inc_obj.".".$s_inc_act.".php");
	} else {
		$s_inc_act = "";
		if(is_string($_GET['inc_act'])) $s_inc_act = $_GET['inc_act'];
