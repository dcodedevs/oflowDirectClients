<?php
if(!function_exists("get_files_fw")) {
	function get_files_fw($dirs, $extensions, $except_dirs, $check_subdirs)
	{
		...
		if (count($sub_dirs)>0 and $check_subdirs)
		{
			...
			$tmp_return=array_merge($tmp_return, get_files_fw($sub_dirs,$extensions,$except_dirs, 1 ));
		}
		return $tmp_return;
	}
}
