<?Php
if(!function_exists("get_dirs_fw")) {
    function get_dirs_fw($dirs,$except_dirs,$check_subdirs)
    {
        ...
        if(count($sub_dirs)>0)
        {
            if ($check_subdirs)
            {
              ...
              $tmp_return=array_merge($tmp_return, get_files_fw($sub_dirs,$except_dirs, 1 ));
            }
        }
        return $tmp_return;
    }
