...
$(document).ready(function() {
  ...
  function fwaFileuploadCallback(data) {
    <?php if(isset($fwaFileuploadConfig['callback']) && $fwaFileuploadConfig['callback']!=''): ?>
  ...
  function fwaFileuploadCallbackAll(data) {
    <?php if(isset($fwaFileuploadConfig['callbackAll']) && $fwaFileuploadConfig['callbackAll']!=''): ?>
    if(data === undefined) var data = {};
  ...
  function fwaFileuploadCallbackDelete(data) {
    <?php if(isset($fwaFileuploadConfig['callbackDelete']) && $fwaFileuploadConfig['callbackDelete']!=''): ?>
    if(data === undefined) var data = {};
  ...
  function fwaFileuploadCallbackStart() {
    <?php if(isset($fwaFileuploadConfig['callbackStart']) && $fwaFileuploadConfig['callbackStart']!=''): ?>
  ...
  function fwaFileuploadInit() {
    ...
    $('#<?php echo $fwaFileuploadConfig['id'];?>_upload').off().fileupload({
      url: '<?php echo $variables->account_framework_url.'getynet_fw/modules/Chat/output/includes/fileuploadchat/ajax_upload.php?param_name='.$fwaFileuploadConfig['id'].'_files'; ?>',
      dataType: 'json',
      formData: {
