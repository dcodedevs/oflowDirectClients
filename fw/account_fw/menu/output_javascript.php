...
function fw_updateLayout() {
	...
	*/
	...
	<?php
	if(isset($variables->fw_settings_basisconfig['mobile_breakpoint']) && $variables->fw_settings_basisconfig['mobile_breakpoint'] != ""){
		?>
...
function fw_optimize_urls()
{
	...
	<?php } ?>
	$('.module_list .list_buttons, .subcontent .list_buttons').on('hover', function() {
