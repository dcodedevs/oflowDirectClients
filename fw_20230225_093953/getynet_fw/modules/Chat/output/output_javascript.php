...
$(document).ready(function()
{
	...
	*/
	FWChat.prototype.show_channel_details = function(channel){
		...
		$(".current_group_chat_info").hover(function(){
	...
	*/
	...
	FWChat.prototype.addListeners = function() {
		...
		$(".channelInfoTrigger").hover(function(){
		...
		$(".channelinfo_hover1").hover(function(){ hoveredOverInfo = true; }, function(){
			$(".channelinfo_hover1").removeClass("active");
			hoveredOverInfo = false;
		})

		var hoveredOverInfo2 = false;
		$(".channelInfoTrigger2").hover(function(){
		...
		$(".channelinfo_hover2").hover(function(){ hoveredOverInfo2 = true; }, function(){
			$(".channelinfo_hover2").removeClass("active");
